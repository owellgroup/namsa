  ...
  ARTIST: [
    {
      ...
      items: [
        ...
        { title: "Performance", url: "/artist/performance", icon: BarChart3 },
      ]
    },
    {
  ...
  ADMIN: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Approved Profiles", url: "/admin/profiles/approved", icon: UserCheck },
        { title: "Rejected Profiles", url: "/admin/profiles/rejected", icon: XCircle },
